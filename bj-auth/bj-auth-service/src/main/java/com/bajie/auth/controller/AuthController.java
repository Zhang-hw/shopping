package com.bajie.auth.controller;

import com.bajie.auth.config.JwtProperties;
import com.bajie.auth.service.AuthService;
import com.bajie.common.pojo.UserInfo;
import com.bajie.common.utils.CookieUtils;
...
public class AuthController {
     ...
     */
    @GetMapping("verify")
    public ResponseEntity<UserInfo> verifyUser(@CookieValue("BJ_TOKEN") String token, HttpServletRequest request, HttpServletResponse response) {
        try {
            // 从token中解析token信息
